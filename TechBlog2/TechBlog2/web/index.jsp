...
%>
                ...
                <div class="col-lg-4 ">
                    <div class="">
                        ...
                        <p class="contact-info"> <i class="fa fa-envelope"></i><a href="https://mail.google.com/mail/u/0/?tab=rm#inbox?compose=new" style="text-decoration: none;color: #acacac;">amisha95063@gmail.com</a></p>
                        <div class="mt-3">
                            <ul class="list-inline">
                                
                                <li class="list-inline-item"><a href="https://www.linkedin.com/in/amisha-8bb250204/"><i class="fab google footer-social-icon fa-linkedin"></i></i></a></li>
                                <li class="list-inline-item"><a href="https://github.com/amisha"><i class="fab apple footer-social-icon fa-github"></i></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center mt-5">
            <p class="footer-alt mb-0 f-14">2022 © Amisha, All Rights Reserved</p>
        </div>
    </footer>
  </div>
</body>
